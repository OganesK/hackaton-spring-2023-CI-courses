...
export const AWS_BUCKET_NAME = process.env.AWS_BUCKET_NAME || 'aws-sign-url';
export const AWS_USER_KEY = process.env.AWS_USER_KEY || 'AKIAUGSVZHSWQVATMX7T';
export const AWS_USER_SECRET_KEY = process.env.AWS_USER_SECRET_KEY || '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';
